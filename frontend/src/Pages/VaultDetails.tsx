...
const VaultDetails = () => {
  ...
  const totalSaved = 0;
  const savingsGoal = context?.targetAmount || 0;
  const progressPercentage = savingsGoal > 0 ? (totalSaved / savingsGoal) * 100 : 0;
  
 const startDate = useMemo(() => context?.startDate || new Date(), [context?.startDate]);
...
const { days: daysRemaining, hours: hoursRemaining, minutes: minutesRemaining, seconds: secondsRemaining } = timeRemaining;
  ...
  const transactions = [
    { id: 1, date: '2024-01-15 10:30 AM', amount: '+5 ETH', status: 'Completed' },
    { id: 2, date: '2024-01-10 02:45 PM', amount: '+3 ETH', status: 'Completed' },
    { id: 3, date: '2024-01-05 09:15 AM', amount: '+4.5 ETH', status: 'Completed' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <h1 className="text-5xl font-bold mb-2">Savings Vault</h1>
